...
const Trades = require('../db/models').trade;
const WaifuLists = require('../db/models').waifu_list;
const Chats = require('../db/models').chat;
const Users = require('../db/models').user;
const Profiles = require('../db/models').user_info;
const Waifus = require('../db/models').waifu;
const Franchises = require('../db/models').franchise;
const WaifuFavoriteLists = require('../db/models').waifu_favorite_list;
